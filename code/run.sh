...
cur_dir=$PWD
data_path=$cur_dir/../toy_data/$lang/
...
mkdir -p 'outfiles/'$1
mkdir -p 'outfiles/'$1/$subword.$compf.$iter.$lr.$bs
outs='outfiles/'$1/$subword.$compf.$iter.$lr.$bs/$train_file."$subword".$compf.ep$iter.lr$lr.bs$bs
